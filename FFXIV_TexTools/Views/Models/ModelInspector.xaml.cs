...
namespace FFXIV_TexTools.Views.Models
{
    ...
    public partial class ModelInspector
    {
        ...
        private void FillModelMetaData()
        {
            ...
            // Unknown 0
            AddText(textBox, "Unknown 0:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown0.ToString()}\n\n", _textColor, true);

            // Mesh Count
            AddText(textBox, "Mesh Count:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.MeshCount.ToString()}\n\n", _textColor, true);

            // Attribute Count
            AddText(textBox, "Attribute Count:\t", _textColor, false);
            ...
            // Material Count
            AddText(textBox, "Material Count:\t", _textColor, false);
            ...
            // Bone List Count
            AddText(textBox, "Bone List Count:\t", _textColor, false);
            AddText(textBox, $"{modelData.BoneListCount.ToString()}\n\n", _textColor, true);

            // Mesh Shape Info Count
            AddText(textBox, "Shape Info Count:\t", _textColor, false);
            ...
            // Unknown 2
            AddText(textBox, "Unknown 2:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown2.ToString()}\n\n", _textColor, true);

            // Unknown 3
            AddText(textBox, "Unknown 3:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown3.ToString()}\n\n", _textColor, true);

            // Unknown 4
            AddText(textBox, "Unknown 4:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown4.ToString()}\n\n", _textColor, true);

            // Unknown 5
            AddText(textBox, "Unknown 5:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown5.ToString()}\n\n", _textColor, true);

            // Unknown 6
            AddText(textBox, "Unknown 6:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown6.ToString()}\n\n", _textColor, true);

            // Unknown 7
            AddText(textBox, "Unknown 7:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown7.ToString()}\n\n", _textColor, true);

            // Unknown 8
            AddText(textBox, "Unknown 8:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown8.ToString()}\n\n", _textColor, true);

            // Unknown 9
            AddText(textBox, "Unknown 9:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown9.ToString()}\n\n", _textColor, true);

            // Unknown 10a
            AddText(textBox, "Unknown 10a:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown10a.ToString()}\n\n", _textColor, true);

            // Unknown 10b
            AddText(textBox, "Unknown 10b:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown10b.ToString()}\n\n", _textColor, true);

            // Unknown 11
            AddText(textBox, "Unknown 11:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown11.ToString()}\n\n", _textColor, true);

            // Unknown 12
            AddText(textBox, "Unknown 12:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown12.ToString()}\n\n", _textColor, true);

            // Unknown 13
            AddText(textBox, "Unknown 13:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown13.ToString()}\n\n", _textColor, true);

            // Unknown 14
            AddText(textBox, "Unknown 14:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown14.ToString()}\n\n", _textColor, true);

            // Unknown 15
            AddText(textBox, "Unknown 15:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown15.ToString()}\n\n", _textColor, true);

            // Unknown 16
            AddText(textBox, "Unknown 16:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown16.ToString()}\n\n", _textColor, true);

            // Unknown 17
            AddText(textBox, "Unknown 17:\t\t", _textColor, false);
            AddText(textBox, $"{modelData.Unknown17.ToString()}\n\n", _textColor, true);

            // Extra LoD Count
            if (_xivMdl.ExtraLoDList != null)
            {
                AddText(textBox, "Extra LoD Count:\t", _textColor, false);
            ...
            {
                AddText(textBox, "Extra Mesh Count:\t", _textColor, false);
        ...
        private void OtherDataComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (selectedItem.Equals("Bounding Box"))
            {
                ...
                AddText(textBox, "Vector Count:\t", _textColor, false);
            ...
            if (selectedItem.Equals("Transforms"))
            {
                ...
                AddText(textBox, "Transform Count:\t", _textColor, false);
        ...
        private void LoDComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            // Mesh Offset
            AddText(textBox, "Mesh Offset:\t\t", _textColor, false);
            ...
            // Mesh End
            AddText(textBox, "Mesh End:\t\t", _textColor, false);
            ...
            // Mesh Sum
            AddText(textBox, "Mesh Sum:\t\t", _textColor, false);
            ...
            // Index Start
            AddText(textBox, "Index Start:\t\t", _textColor, false);
            ...
            // Vertex Size
            AddText(textBox, "Vertex Size:\t\t", _textColor, false);
            AddText(textBox, $"{lod.VertexDataSize}\n\n", _textColor, true);

            // Index Size
            AddText(textBox, "Index Size:\t\t", _textColor, false);
            AddText(textBox, $"{lod.IndexDataSize}\n\n", _textColor, true);

            // Vertex Offset
            AddText(textBox, "Vertex Offset:\t\t", _textColor, false);
